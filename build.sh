...
NATIVE_APP_GLUE=~/Android/android-ndk-r27b/sources/android/native_app_glue
...
$BUILD_TOOLS/aapt package -f -m \
	...
	-I ~/Android/platforms/android-29/android.jar

# Compile NativeLoader.java
javac -verbose -source 1.8 -target 1.8 -d android/build/obj \
	-bootclasspath jre/lib/rt.jar \
	-classpath ~/Android/platforms/android-29/android.jar:android/build/obj \
...
$BUILD_TOOLS/aapt package -f \
	...
	-I ~/Android/platforms/android-29/android.jar -F game.apk android/build/dex
